...
var changeStatus = function(num, status) {
    $.ajax({
        url: '/changeStatutDevis',
...
$(document).ready(function() {
    ...
    $('.displayDetails').click(function() {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#modalDetails').attr('x-id', res.id);
                switch (res.status) {
                case 'submitted':
                    $('#status').text('Soumis, en attente');
                    break;
                case 'validated':
                    $('#status').text('Validé');
                    break
    ...
    $('.reject').click(function() {
        let id = $('#modalDetails').attr('x-id');
        changeStatus(id, 'rejected');
    });
    $('.validate').click(function() {
        let id = $('#modalDetails').attr('x-id');
        changeStatus(id, 'validated');
    });
});
